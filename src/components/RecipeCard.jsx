  ...
  return (
    <div className="sm:w-[250px] flex flex-col bg-white p-5 rounded-md w-full relative sm:mr-5 mb-5 shadow-2xl">
      ...
      <div className="img w-full h-[200px] bg-green-200">
        ...
        />
      </div> <div className="diet-type sm:text-[10px] text-[12px] ml-auto font-semibold text-gray-500">{recipe.diet}</div>
      <p className="font-bold uppercase mt-[1px] ">{recipe.recipeName.slice(0,20)+".."}</p>
      ...
      <a href={recipe.url} target="_blank"> <button className="w-full px-2 py-2 rounded-md bg-[#ff5c01] text-white uppercase font-semibold mt-4  text-[15px]">Lets Try</button></a>
